...
void updateFrogger(FROGGER*);
void updateLeftCar(LEFTCAR*);
void updateRightCar(RIGHTCAR*);
void drawFrogger(FROGGER*);
void drawLeftCar(LEFTCAR*);
void drawRightCar(RIGHTCAR*);
# 6 "main.c" 2
# 1 "font.h" 1
...
void goToStart()
{
 ...
 drawString(20, 10, "To Play, Press START", ((0) | (31)<<5 | (0)<<10));
 drawString(30, 10, "For Instructions, Press SELECT", ((0) | (31)<<5 | (0)<<10));
 drawRect(80, 100, 8, 6, ((0) | (31)<<5 | (0)<<10));
 drawRect((80 + 1), (100 - 3), 2, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((80+1)-2),(100-3), 2, 2, ((0) | (31)<<5 | (0)<<10));
 drawRect((80 + 1), (100 + 6), 2, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((80 + 1) - 2), ((100 + 6) + 1), 2, 2, ((0) | (31)<<5 | (0)<<10));
 drawRect((80 + 5), (100 - 3), 3, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((80 + 5) - 1), (100 - 3), 1, 2, ((0) | (31)<<5 | (0)<<10));
 drawRect((80 + 5), (100 + 6), 3, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((80 + 5) - 1), ((100 + 6) + 1), 1, 2, ((0) | (31)<<5 | (0)<<10));
...
void goToInstructions()
{
 ...
 fillScreen(0);
 drawString(10, 2, "To play: Use arrow keys to move frogger.", ((0) | (31)<<5 | (0)<<10));
 drawString(25, 8, "Cross the street without getting hit.", ((0) | (31)<<5 | (0)<<10));
 drawString(40, 16, "If you're hit 3 times, GAME OVER!", ((0) | (31)<<5 | (0)<<10));
 drawString(55, 10, "Must look both ways before crossing!", ((0) | (31)<<5 | (0)<<10));
 drawString(70, 16, "Therefore, cannot move sideways on", ((0) | (31)<<5 | (0)<<10));
 drawString(85, 50, "yellow lines in middle.", ((0) | (31)<<5 | (0)<<10));
 drawString(100, 25, "To Pause the game, press START!", ((0) | (31)<<5 | (0)<<10));

 drawRect(120, 120, 8, 6, ((0) | (31)<<5 | (0)<<10));
 drawRect((120 + 1), (120 - 3), 2, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((120+1)-2),(120-3), 2, 2, ((0) | (31)<<5 | (0)<<10));
 drawRect((120 + 1), (120 + 6), 2, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((120 + 1) - 2), ((120 + 6) + 1), 2, 2, ((0) | (31)<<5 | (0)<<10));
 drawRect((120 + 5), (120 - 3), 3, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((120 + 5) - 1), (120 - 3), 1, 2, ((0) | (31)<<5 | (0)<<10));
 drawRect((120 + 5), (120 + 6), 3, 3, ((0) | (31)<<5 | (0)<<10));
 drawRect(((120 + 5) - 1), ((120 + 6) + 1), 1, 2, ((0) | (31)<<5 | (0)<<10));
 drawString(150, 40, "Press START to Begin now.", ((0) | (31)<<5 | (0)<<10));
...
void initializeGame()
{
 ...
 fillScreen(0);
 drawRect(20, 0, 5, 240, ((31) | (31)<<5 | (31)<<10));
 drawRect(130, 0, 6, 240, ((31) | (31)<<5 | (31)<<10));
 drawRect(73, 0, 4, 240, ((31) | (31)<<5 | (0)<<10));
 drawRect(79, 0, 4, 240, ((31) | (31)<<5 | (0)<<10));
 drawRect(136, 0, 23, 240, ((5) | (10)<<5 | (0)<<10));
 drawRect(0, 0, 20, 240, ((0) | (0)<<5 | (31)<<10));
 ...
 leftCars[0].row = 30;
 leftCars[0].col = 220;
 leftCars[0].color = ((0) | (0)<<5 | (31)<<10);

 leftCars[1].row = 50;
 leftCars[1].col = 100;
 leftCars[1].color = ((31) | (0)<<5 | (0)<<10);

 leftCars[2].row = 60;
 leftCars[2].col = 200;
 leftCars[2].color = ((12) | (7)<<5 | (17)<<10);

 rightCars[0].row = 85;
 rightCars[0].col = 5;
 rightCars[0].color = ((23) | (20)<<5 | (0)<<10);

 rightCars[1].row = 90;
 rightCars[1].col = 140;
 rightCars[1].color = ((31) | (31)<<5 | (16)<<10);

 rightCars[2].row = 115;
 rightCars[2].col = 185;
 rightCars[2].color = ((0) | (31)<<5 | (31)<<10);

 rightCars[3].row = 125;
 rightCars[3].col = 65;
 rightCars[3].color = ((31) | (0)<<5 | (31)<<10);
...
void updateGame()
{
 ...
 for (int i = 0; i < 3; i++)
 {
   ...
   ((((player.row + 1) - 2) + player.height) > leftCars[i].row) && (((player.col - 3) + player.width) >= leftCars[i].col))
  {
   ...
   drawRect(73, 0, 4, 240, ((31) | (31)<<5 | (0)<<10));
   drawRect(79, 0, 4, 240, ((31) | (31)<<5 | (0)<<10));
   drawRect(83, 0, (130 - 83), 240, 0);
   drawRect(25, 0, (73 - 25), 240, 0);
...
void drawLives()
{
 ...
 drawString(10, 12, lifeBuffer, ((31) | (31)<<5 | (31)<<10));
 oldLife = life;
...
void goToPause()
{
 drawString(148, 10, "Your Paused! Press START to continue", ((23) | (20)<<5 | (0)<<10));
 state = PAUSE;
}
...
void goToWin()
{
 ...
 drawString(55, 40, "YOU WIN! CONGRATS!!", ((23) | (20)<<5 | (0)<<10));
 drawString(65, 40, "PRESS START TO PLAY AGAIN!", ((23) | (20)<<5 | (0)<<10));
 state = WIN;
}
...
void goToLose()
{
 ...
 drawString(55, 40, "YOU LOSE! TRY AGAIN!!", ((23) | (20)<<5 | (0)<<10));
 drawString(65, 40, "PRESS START TO PLAY AGAIN!", ((23) | (20)<<5 | (0)<<10));
 state = LOSE;
}
